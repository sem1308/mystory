...
public class BlogHistoryQueryRepositoryImpl extends Querydsl4RepositorySupport<BlogHistory, QBlogHistory> implements BlogHistoryQueryRepository{

    public BlogHistoryQueryRepositoryImpl() {
