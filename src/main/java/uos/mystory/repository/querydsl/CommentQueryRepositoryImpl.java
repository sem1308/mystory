...
public class CommentQueryRepositoryImpl extends Querydsl4RepositorySupport<Comment, QComment> implements CommentQueryRepository{

    public CommentQueryRepositoryImpl() {
    ...
    public Optional<SelectCommentInfoDTO> findDtoById(Long commentId) {
        //== 자동 countQuery 생성 방법==//
