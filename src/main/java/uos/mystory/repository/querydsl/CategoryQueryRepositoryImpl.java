...
public class CategoryQueryRepositoryImpl extends Querydsl4RepositorySupport<Category, QCategory> implements CategoryQueryRepository{

    public CategoryQueryRepositoryImpl() {
