...
public class GuestBookQueryRepositoryImpl extends Querydsl4RepositorySupport<GuestBook, QGuestBook> implements GuestBookQueryRepository{

    public GuestBookQueryRepositoryImpl() {
    ...
    public Optional<SelectGuestBookInfoDTO> findDtoById(Long guestBookId) {
        //== 자동 countQuery 생성 방법==//
