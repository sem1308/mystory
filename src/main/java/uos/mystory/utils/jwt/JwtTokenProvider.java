...
import uos.mystory.dto.response.ResponseUserAuthDTO;
...
public class JwtTokenProvider implements InitializingBean {
    ...
    public String createToken(Authentication authentication) {
        // 인증된 Authentication 객체에 대한 JWT 토큰 생성
        ...
        return Jwts.builder()
                ...
                .claim(USER_KEY,userDTO) // 사용자 데이터 저장
    ...
    public Authentication getAuthentication(String token) {
        ...
        return new UsernamePasswordAuthenticationToken(claims.get(USER_KEY), token, authorities);
    }
